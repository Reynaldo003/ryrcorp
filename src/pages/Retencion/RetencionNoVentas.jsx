// src/pages/Retencion/RetencionNoVentas.jsx
...
import {
    apiRetencion,
    obtenerOpcionesRetencionNoVentas,
...
export default function RetencionNoVentas() {
    ...
    useEffect(() => {
        ...
        async function cargarOpciones() {
            try {
                ...
                const data = await obtenerOpcionesRetencionNoVentas({
